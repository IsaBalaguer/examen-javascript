...
function saludar () {
  return `${persona.nombre} ${persona.apellido}, ¿Como estás?`;
...
function comparar (num1, num2) { if (num1 > num2) {
  return "Es mayor";
}else if (num1 < num2) {
  return "Es menor"};
...
function Contacto (nombre, apellido, telefono) {
  ...
  this.contact = function() {
    return `El teléfono de ${nombre} ${apellido} es ${telefono}`;
  }
